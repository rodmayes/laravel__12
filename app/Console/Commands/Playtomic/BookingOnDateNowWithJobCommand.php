...
class BookingOnDateNowWithJobCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Realiza las reservas de Playtomic en el momento con un job';
    ...
    public function handle(): void
    {
        ...
        foreach ($bookings as $booking) {
            (new PlaytomicBookingService($user))->processSingleBooking($booking, true);
        }
